...
const baseQueryWithReauth = async (args, api, extraOptions) => {
  const baseQuery = fetchBaseQuery({
    // baseUrl: "http://10.0.80.75:6002/api/v1",
    // baseUrl: "http://24.144.116.12:5000/api/v1",
    baseUrl: "https://api.learnova.info/api/v1",
...
export const api = createApi({
  ...
  tagTypes: ["Banner", "AdminData", "Faq"],
  endpoints: () => ({}),
});

// Export the image URL as a constant
// export const imageUrl = "http://10.0.80.75:6002";
// export const imageUrl = "http://24.144.116.12:5000/api/v1";
export const imageUrl = "https://api.learnova.info/api/v1";
